...
import io.spring.start.site.rocky.RockyProjectDescription;
...
/**
 * <p> </p>
 * {@link  io.spring.initializr.web.project.DefaultProjectRequestToDescriptionConverter}

 *
 * @author wangji
 * @date 2024/7/11 22:57
 */
public class RockyProjectRequestToDescriptionConverter implements ProjectRequestToDescriptionConverter<RockyWebProjectRequest> {

    private final ProjectRequestPlatformVersionTransformer platformVersionTransformer;

    public RockyProjectRequestToDescriptionConverter() {
    ...
    @Override
    public ProjectDescription convert(RockyWebProjectRequest request, InitializrMetadata metadata) {
        RockyProjectDescription description = new RockyProjectDescription();
     ...
     */
    public void convert(ProjectRequest request, RockyProjectDescription description, InitializrMetadata metadata) {
        ...
        //region 这里是针对源码修改的!
        description.setBuildType(metadata.getTypes().get(request.getType()));
        //endregion
    }
